...
| `frontend/src/view/plcLayouts.js` | **Machine models**, 1:1 with firmware personalities. Each model has `firmware`, `feeders:[[n,[reactors]]]` and optional `downstream:{}`. `modelsAvailable`, `resolveModel`, `feederForReactor`. |
